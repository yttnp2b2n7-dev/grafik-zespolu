...
// Pure presentational component - no font-registration side effect, so it
// can be reused as-is from both the client (with client-side URL fonts) and
// the server (with filesystem fonts) without the two registrations
// clobbering each other. See PersonPeriodPdf.tsx / registerFonts.ts.
